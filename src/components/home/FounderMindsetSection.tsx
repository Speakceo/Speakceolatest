...
import { Rocket, Zap, TrendingUp, Sparkles, Target, Users, Lightbulb, Brain, ArrowRight } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "Create your own business, personal brand, or startup idea. Launch pages, websites, and landing pages that actually convert.",
    ...
    },
    {
      ...
      description: "Learn how to market yourself and your ideas. Master storytelling, growth basics, and ethical marketing with social media.",
  ...
  return (
    <section className="relative py-28 overflow-hidden bg-slate-950">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-[-20%] left-[-10%] w-[45%] h-[45%] bg-[#1876D2]/15 rounded-full filter blur-[120px]" />
        <div className="absolute bottom-[-15%] right-[-10%] w-[40%] h-[40%] bg-[#00B0FF]/10 rounded-full filter blur-[100px]" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-8">
            ...
            <span className="text-sm font-medium text-gray-400">The Future of Learning</span>
          </div>

          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight tracking-tight">
            <span className="text-white">Where Students Become </span>
            <br />
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed">
            ...
            <span className="text-[#00B0FF] font-medium">build, launch, and market real things</span> using AI and modern tools.
          </p>
        </motion.div>

        {/* Feature Cards — glass with numbered accent */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24">
          {features.map((feature, index) => (
            ...
            >
              <div className="relative bg-white/[0.03] backdrop-blur-sm rounded-2xl p-8 border border-white/[0.06] hover:border-white/[0.12] transition-all duration-500 h-full">
                {/* Number watermark */}
                <div className="absolute top-4 right-6 text-6xl font-black text-white/[0.03] select-none">{feature.number}</div>

                {/* Icon */}
                <div className={`inline-flex p-3.5 rounded-xl bg-gradient-to-br ${feature.gradient} mb-6 shadow-lg shadow-[#1876D2]/10`}>
                  <feature.icon className="h-6 w-6 text-white" />
                </div>

                <h3 className="text-xl font-bold text-white mb-3">{feature.title}</h3>

                <p className="text-gray-400 mb-6 leading-relaxed text-sm">{feature.description}</p>

                {/* Tags */}
                <div className="flex flex-wrap gap-2">
                  {feature.highlights.map((h, i) => (
                    <span key={i} className="px-2.5 py-1 rounded-md bg-white/[0.04] text-gray-500 text-[11px] font-medium border border-white/[0.06]">
                      {h}
                    </span>
                  ))}
                </div>
        ...
        {/* AI-First Block — Split with Lottie */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
            ...
            <div className="relative grid md:grid-cols-2 gap-12 items-center p-10 md:p-14">
              ...
              <div>
                ...
                <h3 className="text-3xl sm:text-4xl font-bold text-white mb-5 leading-tight">
                  Students Use AI as a <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1876D2] to-[#00B0FF]">Co-Builder</span>
                </h3>

                <p className="text-gray-400 text-base mb-8 leading-relaxed">
                  We don't teach AI theory. We teach students to use AI smartly to build real things — from generating ideas to creating content, websites, and communication.
                </p>

                <div className="grid grid-cols-2 gap-3">
                  {["AI-First Learning", "Human + AI Collab", "Prompt Thinking", "Future-Ready Skills"].map((skill, i) => (
                    <div key={i} className="flex items-center gap-2.5 bg-white/[0.03] rounded-lg px-3 py-2 border border-white/[0.06]">
        ...
        >
          <div className="relative rounded-3xl overflow-hidden border border-white/[0.06] p-12 md:p-16">
            {/* Gradient bg */}
            ...
            <div className="relative">
              <h3 className="text-3xl sm:text-4xl font-bold text-white mb-4 leading-tight">
                ...
                <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1876D2] to-[#00B0FF]">Won't Wait Till College</span>
              </h3>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-14">
                <button className="group px-8 py-4 bg-gradient-to-r from-[#1876D2] to-[#00B0FF] text-white font-semibold rounded-xl shadow-lg shadow-[#1876D2]/25 hover:shadow-xl hover:shadow-[#1876D2]/40 transition-all duration-300 hover:scale-[1.02]">
              ...
              <div className="grid grid-cols-3 gap-6 max-w-lg mx-auto">
                {[
                  ...
                  <div key={i} className="text-center">
                    <div className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#1876D2] to-[#00B0FF]">{s.value}</div>

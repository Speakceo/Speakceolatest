  ...
  return (
    <Card className="w-full h-[500px] bg-black/[0.96] relative overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row h-full">
        {/* Left content */}
        <div className="flex-1 p-4 sm:p-6 md:p-8 relative z-10 flex flex-col justify-center">
          ...
          <p className="mt-3 md:mt-4 text-neutral-300 max-w-lg text-sm md:text-base">
